              ...
              <div className='grid grid-cols-6 gap-6'>
                ...
                <div className='col-span-6 sm:col-span-6'>
                  ...
                  <input
                    ...
                    className='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm'
                    onChange={e => setNewListingState({ ...newListingState, address: e.target.value })}
                    value={newListingState.address}
                  />
                </div>
                ...
                <div className='col-span-6 sm:col-span-3'>
                  ...
                  <select
                    ...
                    className='mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm'
                    onChange={e => setNewListingState({ ...newListingState, country: e.target.value })}
                    value={newListingState.country}
                  >
                ...
                <div className='col-span-6 sm:col-span-6 lg:col-span-2'>
                  ...
                  <input
                    ...
                    className='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm'
                    onChange={e => setNewListingState({ ...newListingState, city: e.target.value })}
                    value={newListingState.city}
                  />
                </div>
                ...
                <div className='col-span-6 sm:col-span-3 lg:col-span-2'>
                  ...
                  <input
                    ...
                    className='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm'
                    onChange={e => setNewListingState({ ...newListingState, region: e.target.value })}
                    value={newListingState.region}
                  />
                </div>
                ...
                <div className='col-span-6 sm:col-span-3 lg:col-span-2'>
                  ...
                  <input
                    ...
                    className='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm'
                    onChange={e => setNewListingState({ ...newListingState, postalCode: e.target.value })}
                    value={newListingState.postalCode}
                  />
                </div>
